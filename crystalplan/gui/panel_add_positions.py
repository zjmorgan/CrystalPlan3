    ...
    def run(self):
        ...
        for i in range( len(self.positions) ):
            try:
                ...
                #     model.messages.send_message(MSG_POSITION_CALCULATION_PROGRESS, str(i))
                #     t_last = time.time()
        ...
        # model.messages.send_message(MSG_POSITION_CALCULATION_PROGRESS, str(len(self.positions)) )
...
#                self.sizerAngles[i].Destroy()
        ...
        for ang in model.instrument.inst.angles:
            ...
            if not ang is None:
                ...
                sizer.Add(static, 0, border=0, flag=wx.EXPAND)
                sizer.Add(text, 1, border=0, flag=wx.EXPAND)
                sizer.Add(static_unit, 0, border=0, flag=wx.EXPAND)
