...
class QspaceViewController(HasTraits):
    ...
    def cleanup(self):
        ...
        model.messages.unsubscribe(self.init_view_objects, model.messages.MSG_EXPERIMENT_QSPACE_CHANGED)
...
class FrameQspaceView(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        # #Set the icon
        # import os
        # icon_file = os.path.join(os.path.dirname(__file__), crystalplan.CrystalPlan_version.icon_file_3d)
