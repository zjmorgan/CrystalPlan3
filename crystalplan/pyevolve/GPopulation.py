...
from crystalplan.pyevolve import Consts, Util
from crystalplan.pyevolve.FunctionSlot import FunctionSlot
from crystalplan.pyevolve.Statistics import Statistics
...
class GPopulation:
   ...
   **Examples**
   ...
   def setMultiProcessing(self, flag=True, full_copy=False, number_of_processes=None):
        ...
        .. warning:: Use this option only when your evaluation function is slow, so you
